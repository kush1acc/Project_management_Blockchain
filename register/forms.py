...
class CompanyRegistrationForm(forms.Form):
    ...
    GSTno = forms.CharField(max_length=100, validators=[alphanumeric])
    ...
    def save(self, commit=True):
        ...
        company.GSTno = self.cleaned_data['GSTno']
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['city'].widget.attrs['class'] = 'form-control'
        self.fields['city'].widget.attrs['placeholder'] = 'City'
        self.fields['GSTno'].widget.attrs['class'] = 'form-control'
        self.fields['GSTno'].widget.attrs['placeholder'] = 'GSTno'
